...
export default {
    ...
    mounted() {
      ...
      $.get(url)
        .then((response) => {
          this.data.center_id = response.office.center.id;
        })
        .catch((error) => {
          console.log(error);
        });
        ...
        create() {
            ...
            axios
                ...
                .then(response => {
                    ...
                    window.dashboard_app.$emit("wardSuccess", response.data);
                    window.dashboard_app.$toasted.show("Saving Success.", {
                        icon: "save"
                    });
                    window.dashboard_app.$emit("endLoading");
                    document.getElementById("wardClose").click();
                })
