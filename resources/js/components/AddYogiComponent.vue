            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="yogiLabel">
                            {{ trans.get("button.create_yogi") }}
                        </h5>
                        <button
                            type="button"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <button
                                ...
                                data-toggle="modal"
                                data-target="#wardModel"
                            >
                                +
                            </button>
                            <label for="ward"
                                >{{ trans.get("input.select_ward") }}
                                <span class="text-danger">*</span></label
                            >
                            <select2
                                :url="fetchWard"
                                ...
                                v-bind:class="{
                                    ...
                                    'is-valid':
                                        submited && !validation.ward_id_hasError
                                }"
                            ></select2>
                            <div
                                class="invalid-feedback"
                                v-if="validation.ward_id_hasError"
                            >
...
import AddWardComponent from './AddWardComponent.vue';
...
export default {
    ...
    created() {
        this.$root.$on("wardSuccess", data => {
            this.data.ward_id = data.id;
        ...
        create() {
            ...
            axios
                ...
                .then(response => {
                    ...
                    document.getElementById("yogiModelClose").click();
                })
