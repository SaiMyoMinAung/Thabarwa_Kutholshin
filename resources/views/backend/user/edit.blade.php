                ...
                <div class="card-body row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input name="name" id="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" placeholder="Enter Name" value="{{$user->name}}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input name="email" type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" placeholder="Enter Email" value="{{$user->email}}">
                            @if ($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input name="phone" type="text" class="form-control only-number {{ $errors->has('phone') ? 'is-invalid' : '' }}" id="phone" placeholder="Enter Phone" value="{{$user->phone}}">
                            @if ($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('state_region_id') ? 'has-error' : '' }}">
                            ...
                            <select name="state_region_id" class="form-control select2 {{ $errors->has('state_region_id') ? 'is-invalid' : '' }}">
                                ...
                                <option value="{{$stateRegion->id}}" @if($user->state_region_id==$stateRegion->id) selected @endif>{{$stateRegion->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('ward_id') ? 'has-error' : '' }}">
                            ...
                            <select name="ward_id" class="form-control select2 {{ $errors->has('ward_id') ? 'is-invalid' : '' }}">
                                ...
                                <option value="{{$ward->id}}" @if($user->ward_id==$ward->id) selected @endif>{{$ward->name}}</option>
                                @endforeach
                            </select>
